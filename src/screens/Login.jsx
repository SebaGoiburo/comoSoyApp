import { StyleSheet, View, Text, Image, Dimensions, SafeAreaView, Pressable, Platform } from 'react-native';
        ...
        if (result?.data && result.isSuccess) {
            (async () => {
                try {
                    ...
                    setLocalId(result.data.localId);
                    ...
                    console.log('User set in Redux:', result.data);
                } catch (error) {
                    console.log('Error setting user session:', error);
                }
            })();
        }
    }, [result, dispatch]);
